% This script is used to solve the Part 3 of Homework 3 for the class CSCI
% 5521 - Introduction to Machine Learning

% Part 2 asks us to apply PCA on the dataset to project it to 2 dimensions
...
%% Section 5: Plotting the Cluster
figure(1);
scatter(X_projection(clusters_Assigned_To_Points==1, 1), X_projection(clusters_Assigned_To_Points==1, 2));
hold on;
scatter(X_projection(clusters_Assigned_To_Points==2, 1), X_projection(clusters_Assigned_To_Points==2, 2));
scatter(X_projection(clusters_Assigned_To_Points==3, 1), X_projection(clusters_Assigned_To_Points==3, 2));
scatter(X_projection(clusters_Assigned_To_Points==4, 1), X_projection(clusters_Assigned_To_Points==4, 2));
scatter(X_projection(clusters_Assigned_To_Points==5, 1), X_projection(clusters_Assigned_To_Points==5, 2));
scatter(X_projection(clusters_Assigned_To_Points==6, 1), X_projection(clusters_Assigned_To_Points==6, 2));
